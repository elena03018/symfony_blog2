...
class LoginAuthenticator extends AbstractLoginFormAuthenticator
{
    ...
    public function authenticate(Request $request): Passport
    {
        ...
        //4- Vérifier si l'email et le mot de passe provenant du formulaire corrispondent 
            //à un utilisateur existent dans la base de données
        return new Passport(
            new UserBadge($email), //"SELECT * FROM user WHERE email=:email"
            new PasswordCredentials($request->getPayload()->getString('password')), // password-verify(string $plainPassword, )
            [
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token, string $firewallName): ?Response
    {
        ...
        //5- Récupérer l'email précedemment envoyé depuis le forumulaire et qui a été sauvegardé en session
        ...
        //6- Dans le cas contraire, 
            ...
            //Redirigions la'dministrateur vers l'espace d'administration 
